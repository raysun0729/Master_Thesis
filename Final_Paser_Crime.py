...
#             jud_law_begin_line_number = find_clerk_line(file_content[split_line_number:])
            ...
            #     pass
            # else:
            if ("年" or "月" in final_jud) and (final_jud != "不受理") and ("附" not in final_jud) and ("。" not in final_jud and "" not in final_jud and "，" not in final_jud and "?" not in final_jud and " " not in final_jud) and ('或' not in final_jud and '逾' not in final_jud):
            ...
            if len(unique_reg_psue_law_articles) >= 1 and prisonment != 0:
                # case
